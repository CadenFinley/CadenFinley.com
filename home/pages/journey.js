...
const REFLECTIONS = [
	...
	},
	{
		...
		paragraphs: [
			...
			"While ACU has greatly helped with this healing, I would be missing a big feature about ACU that I find extremely lacking. The chapel experience. I find that it is now just a todo list or a checkmark that needs to be completed which I am pretty sure that Jesus would not like very much. This is exemplified by using as a means to justify a completion of credits or by satisfying a scholarship requirement. This has been disappointing to me as I would love a space to do life with other Jesus loving people and a space to act on this, but Chapel simply is not that at ACU. Leadership Camps is a far better example of this than Chapel.",
