...
function createProjectElement(repo, config) {
  ...
  //         <button class="project-button chat-button"
  //         onclick="window.open('/chat_frontend/login.html', '_blank')">
  //           Try my web chat app!
  //         </button>
  //         <button class="project-button old-site-button"
  //         onclick="window.open('/chat_frontend/old_home.html', '_blank')">
  //           Visit old website
  //         </button>
  //       </div>
  //     `;
