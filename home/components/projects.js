...
const PROJECT_CONFIG = {
  'CadenFinley.com': {
    ...
    description: 'My personal dev portfolio. Previously this was a well-featured, very fancy looking webpage with a WebSocket-based, database-backed, JWT-secured web chat service. I have since removed all of this and opted for a much simpler webpage as I feel that reflects more of who I am.',
    order: 3
  },
  'CJsShell': {
    title:
    ...
    description: [
      'Built-in are a POSIX shell interpreter with bash extensions, customizable keybindings, syntax highlighting, fuzzy completions, smart directory navigation, advanced history search, multiline editing, spell corrections, typeahead, and rich prompts. Everything ships in one binary with a single vendored dependency, so cjsh works out of the box on all *nix-like systems and Windows via WSL. cjsh delivers a POSIX+ experience, standard scripting semantics with an enhanced interactive layer that you can fully customize. cjsh has been in development for over 1 full year and is now my default login shell for my macOS and Linux workstations with no fallbacks built in onto other shells.',
      'In cjsh lies another one of my long-term projects, isocline. isocline was originally a project started by Daan Leijan ( https://github.com/daanx/isocline ) that I have now HEAVILY adapted to work within cjsh to give it its super rich interactions. The fork lives here: https://github.com/CadenFinley/isocline and powers cjsh, which is about ~50k lines of code all in, ~15k of which is now C code in the form of isocline.',
      'This project has an accompanying CI suite that covers ~1600 tests for cjsh across an immense multitude of things. cjsh is also packaged on AUR and on homebrew for ease of installation and use. Additionally, cjsh uses CMake so it is pretty much universally buildable on all *nix systems. cjsh is also heavily documented via GitHub Pages which is accessible here: https://cadenfinley.github.io/CJsShell/',
      'I love talking about this project and answering any and all questions about this project as it is single-handedly the project I have learned the most from, and it has been my brainchild for quite some time now and has taken a majority of my focus at times. So please, reach out and ask me literally anything about this project, I would love to talk about it.'
    ],
    order: 1
  },
  'isocline': {
    title:
      ...
      description: [
        'When I first started looking for a line editor for cjsh I was 100% convinced I was going to create my own as all other options I found just didn\'t have what I was looking for. I got pretty far into this project but I realized that it was taking a lot of development time away from cjsh. That was when I found isocline. isocline was a game changer. It, out of the box, had most of the features I was looking for as I was looking for something that would be similar to reedline from nushell or the line editor from fish. While isocline was not as advanced as these products, it had what was important to use as a base to build off of. It had \'matured\' or I guess in other ways was deprecated, but it was no longer receiving many updates. So I did not have to worry about upstream changes breaking all of my changes. It was also MIT licensed which was great as cjsh is MIT licensed and I would be able to make all of my changes without violating any copyrights. It also had some of the basics of every feature that I wanted. And lastly, the actual code inside was concise and clean (well as much as C code can be) and it was really easy to see what everything should be doing.',
        'Some of the features that I was looking for, isocline had it all, mostly. Syntax highlighting, multiline editing, completions, history controls and searching, and a well-documented API. Since I started working with isocline basically every feature has been touched. Every feature has been expanded upon and is much more powerful, and every feature can be dialed up or down. All of this is accessible through the isocline API and allows me to have feature toggles via \'cjshopt\' in cjsh. One main feature that I had to build from the ground up was the status underline, and the live-updating completions menu. Both of these features are found in IDEs and in other more modern shells like fish and nushell, and even smaller shells like elvish and murex. Once these features were in place the shell\'s line-editing functionality was vastly improved. Another feature I introduced was logical vs physical lines and line numbers. This allowed native multiline script writing which is just flat out missing from other shells.',
