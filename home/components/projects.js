...
const PROJECT_CONFIG = {
  ...
  'CJsShell': {
    ...
    description: [
      ...
      'In cjsh lies another one of my long term projects, isocline. isocline was originally a project started by Daan Leijan ( https://github.com/daanx/isocline ) which I have now HEAVILY adapted to work within cjsh to give it its super rich interactions. cjsh is about ~50k lines of code all in, ~15k of which is now c code in the form of isocline. While I am planning on having a traditional fork of this version of isocline that I package with cjsh, at the moment this does not exist.',
